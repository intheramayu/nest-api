...
export class InitMigration1747125720716 implements MigrationInterface {
    name = 'InitMigration1747125720716'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`username\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`refresh_token\` varchar(255) NULL, \`role\` enum ('superuser', 'admin') NOT NULL DEFAULT 'admin', \`company_id\` varchar(255) NOT NULL, \`status\` varchar(255) NOT NULL DEFAULT 01, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` datetime(6) NULL, \`deleted_by\` varchar(255) NULL, \`updated_by\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
